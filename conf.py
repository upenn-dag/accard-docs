...
api_url = 'http://accard.med.upenn.edu/api'
...
latex_documents = [
  ('index', 'Accard.tex', u'Accard Documentation',
   u'Accard community', 'manual'),
]
...
man_pages = [
    ('index', 'accard', u'Accard Documentation',
     [u'Accard community'], 1)
]
...
texinfo_documents = [
  ('index', 'Accard', u'Accard Documentation',
   u'Accard community', 'Accard', 'One line description of project.',
   'Miscellaneous'),
]
